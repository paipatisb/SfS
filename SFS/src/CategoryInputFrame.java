...
public class CategoryInputFrame extends JFrame implements ActionListener {
	...
	public CategoryInputFrame(CategoryManager categoryManager) {
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource().equals(btnOk)){
			try{
				...
				int dialogueResult = JOptionPane.showConfirmDialog(this, "Are you sure you want to attach this category to this product?", "Warning", JOptionPane.YES_NO_OPTION);
				if(dialogueResult ==JOptionPane.YES_OPTION){
					
					Category selectedCategory =(Category)categoryManager.getList().get(selectedIndex) ;
					System.out.printf("%s", selectedCategory.getCategoryName());
